...
class SlackCommandBlock extends Component {
  ...
  render() {
    const { command, responseHeading, events } = this.props
...
const SlackEventCommand = handleViewport(SlackCommandBlock, { threshold: 0.75 })

export default SlackEventCommand
